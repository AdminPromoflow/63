  ...
  <section class="cp-card" aria-labelledby="cp-var-title">
    ...
    <form id="variationForm" class="cp-form" autocomplete="off" novalidate>
      ...
      <div class="cp-field cp-field-full">
        <label class="cp-label" for="variation_image">Image <small style="font-weight:400; color:var(--muted)">(icon-image)</small></label>
        ...
        <small class="cp-hint">An icon-sized image is recommended (e.g., ≤ 128×128). The server can resize it.</small>
      ...
      <div class="cp-field cp-field-full">
        ...
        <div class="cp-inline-row">
          ...
          <button type="button" class="btn" id="clear_pdf">Remove</button>
        </div>
        <div class="cp-file-preview" id="pdf_preview" aria-live="polite">
          <a href="#">No file selected.</a>
        </div>
      </div>
