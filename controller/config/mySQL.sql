...
/*  Created On : 24-Nov-2025 7:25:25 PM 				*/
/*  DBMS       : MySql 						*/
/* ---------------------------------------------------- */
...
(
	...
	CONSTRAINT `PK_Table1` PRIMARY KEY (`category_id` ASC)
)
...
(
	...
	CONSTRAINT `PK_Table1` PRIMARY KEY (`job_id` ASC, `variation_id` ASC)
)
...
ALTER TABLE `products`
 ADD INDEX `IXFK_products_categories` (`category_id` ASC)
;
